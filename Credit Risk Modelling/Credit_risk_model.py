...
# Load the dataset
a1 = pd.read_excel("D:\DS Projects\Credit Risk Modelling\case_study1.xlsx")
a2 = pd.read_excel("D:\DS Projects\Credit Risk Modelling\case_study2.xlsx")
...
a3 = pd.read_excel(r"D:\DS Projects\Credit Risk Modelling\New folder\Unseen_Dataset.xlsx")
...
model = xgb.XGBClassifier(objective='multi:software',
                                      num_class=4,
...
a3.to_excel (r"C:\Users\Asus\Desktop\Final_Prediction.xlsx", index=False)
